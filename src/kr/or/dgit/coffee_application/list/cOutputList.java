...
public class cOutputList extends AbstractList {
	
	private cOutputService service;
	
	public cOutputList(cOutputService service) {
	...
	protected Object[][] getData() {
		List<cOutput> lists = service.selectcOutputByAll();
	...
	public Object getSelectedItem() {
		...
		return service.selectcOutputByNo(new cOutput(cNo));
	}
